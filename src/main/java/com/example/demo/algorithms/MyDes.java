...
public class MyDes {
    ...
    private DesDataLogger desDataLogger = new DesDataLogger();

    public DesDataLogger getDesDataLogger() {
        return desDataLogger;
    }
    ...
    String round(String input, String key, int num)
    {
        ...
        // xor
        left = xor(left, temp);
        desDataLogger.getRounds().add("Round " +(num + 1) + " " + right + " " + left + " " + key);
    ...
    public String encrypt(String plainText, String key)
    {
        ...
        desDataLogger.setPermutation(plainText);
        desDataLogger.setLeft(plainText.substring(0, 8));
        desDataLogger.setRight(plainText.substring(8, 16));
        ...
        desDataLogger.setRounds(new ArrayList());
        // 16 rounds
        for (i = 0; i < 16; i++) {
